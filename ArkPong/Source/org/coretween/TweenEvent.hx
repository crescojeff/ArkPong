...
class TweenEvent extends Event
{
	...
	public var source(get_source, set_source):Tweenable;
 	private function get_source():Tweenable
	{
		return(this._source);
	}
	
	private function set_source(source:Tweenable):Void
	{
		this._source=source;
	}
	
	public function new(type:String, source:Tweenable, bubbles:Bool=false, cancelable:Bool=false)
	{
